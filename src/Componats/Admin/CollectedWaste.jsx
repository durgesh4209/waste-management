...
export default function CollectedWaste() {
    ...
    // useEffect(() => {
    //     // Fetch cart data
    //     fetch("https://your-backend-api.com/cart")
                                    ...
                                    <div key={product.id} className="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
                                        <div className="block2">
                                            <div className="block2-pic hov-img0">
                                                ...
                                                <Link to={`/addToRecycled/${product.id}`} className="block2-btn flex-c-m stext-103 cl2 size-102 bor2 hov-btn1 p-lr-15 trans-04">
                                                    Quick View
                                                </Link>
                                            </div>

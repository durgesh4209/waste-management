...
const ShoppingCart = () => {
    const [items, setItems] = useState([
        { id: 1, name: 'Plastic Waste', price: 190, quantity: 1, image: 'Plastic-waste-1.jpg' },
        { id: 2, name: 'Electronic Waste', price: 439, quantity: 1, image: 'Electronic-waste-1.webp' },
        { id: 3, name: 'Medical Waste', price: 217, quantity: 1, image: 'Medical-waste-1.webp' },
    ]);
                ...
                <div className="row">
                    ...
                    <div className="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                        <div className="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                                ...
                                <div className="size-209 p-r-18 p-r-0-sm w-full-ssm">
                                    ...
                                    <div className="p-t-15">
                                        ...
                                        <div className="bor8 bg0 m-b-12">
                                            <input className="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="state" placeholder="State / city" onChange={handleShippingChange} />
                                        </div>

                                        <div className="bor8 bg0 m-b-22">
                                            <input className="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="postcode" placeholder="Postcode / Zip" onChange={handleShippingChange} />
                                        </div>
                                        <div className="bor8 bg0 m-b-22">
                                            <input className="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="Building Name" placeholder="Area/Building Name" onChange={handleShippingChange} />
                                        </div>
                            ...
                            <a href="pyment.html" className="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">Proceed to Checkout</a>
                        </div>
                    </div>
                </div>
            </div>
